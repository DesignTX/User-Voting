//middleware acts as a bridge that connects network based requests generated by a client to the back end data the client is requesting.
...
// to make the poll you need the user id that comes from mongo
